...
variable "db_username" {
  ...
  type        = string
  default     = "daman" # TODO: student supplies
}
...
variable "db_password" {
  ...
  type        = string
  sensitive   = true
  default     = "redpillman" # TODO: student supplies
}

variable "sns_email_endpoint" {
  description = "Email for SNS subscription (PagerDuty simulation)."
  type        = string
  default     = "chrisb@chrisbdevsecops.com" # TODO: student supplies
}