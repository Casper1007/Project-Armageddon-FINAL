variable "domain_name" {
  description = "Base domain students registered (e.g., chrisbarm-growl.com)."
  type        = string
  default     = "chrisbarm-growl.com"
}

variable "app_subdomain" {
  description = "App hostname prefix (e.g., app.chrisbarm-growl.com)."
  type        = string
  default     = "app"
}
